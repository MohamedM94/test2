...
def get_client():
    ...
    response = requests.get(f"https://mohamedtest3.streamlit.app/credit")
...
def infos_client(client, col):
    ...
    response = requests.get(f"https://mohamedtest3.streamlit.app/{client}/data")
...
def get_proba_for_client(client: int):
    ...
    local_api_url=f"mohamedtest3.streamlit.app/{client}/predict"
